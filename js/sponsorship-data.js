/* ============================================================
   ...
   ⚠️  PRICING — RECONCILED WITH THE 2025 SPONSORSHIP PACKAGE PDF
   The PDF's tiers and rates were extracted via the interactive flipbook
   (pdf.js client-side render). The PDF runs Platinum → Public; Grand
   is preserved as the aspirational top tier per ASAAL's design brief.
   Update this file whenever next year's package is finalized.
   ============================================================ */
(function () {
  'use strict';
  ...
  const LEVELS = [
    ...
    },
    {
      ...
      amount: 10000,
      amountLabel: '$10,000',
      tagline: 'Top tier in the 2025 sponsorship package.',
